      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {pulseMetrics.map((metric, index) => {
            ...
            return (
              <Card key={index} className={`p-6 space-y-4 gradient-border hover:shadow-lg transition-shadow card-hover scroll-animate scroll-delay-${(index + 1) * 100}`}>
        ...
        {/* Radar Chart */}
        <Card className="p-8 space-y-6 scroll-animate gradient-border">
        ...
        <div className="space-y-10 scroll-animate">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {[
              ...
              return (
                <Card key={index} className={`p-6 hover:shadow-lg transition-shadow gradient-border scroll-animate scroll-delay-${(index + 1) * 100}`}>
                  {/* Category Name */}
              ...
              <div key={catIndex} className="space-y-8 scroll-animate">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {category.elements.map((element, elIndex) => (
                    <Card key={elIndex} className={`p-6 flex gap-6 hover:shadow-lg transition-shadow gradient-border scroll-animate-scale scroll-delay-${(elIndex + 1) * 100}`}>
        ...
        <div className="space-y-6 scroll-animate">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="p-6 flex flex-col items-center justify-center bg-white shadow-sm hover:shadow-md transition-shadow card-hover gradient-border scroll-animate-left">
            ...
            {/* eNPS Score Card */}
            <Card className="p-6 bg-white shadow-sm hover:shadow-md transition-shadow card-hover gradient-border scroll-animate-right">
